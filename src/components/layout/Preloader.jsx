...
const Preloader = ({ onFinish }) => {
    ...
    return (
        <div
            className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#0F172A] transition-opacity duration-700 ${fadeLimit ? "opacity-0 pointer-events-none" : "opacity-100"
                }`}
        >
            {/* --- BRAND ICON --- */}
