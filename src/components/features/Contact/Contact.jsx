...
const Contact = () => {
    ...
    return (
        <section id="contact" className="relative bg-slate-950 pt-16 md:pt-24 pb-12 overflow-hidden text-white border-t border-slate-900/50">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 mb-16 md:mb-24">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-6 text-white leading-[1.1]">
                        ...
                        <div className="space-y-4 md:space-y-6">
                            <a href="mailto:manthanvaghasiya60@gmail.com" className="group flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-blue-500/10 hover:border-blue-500/30 transition-all duration-300">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm md:text-lg font-semibold text-white group-hover:text-blue-200 transition-colors truncate">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-slate-900/40 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-2xl md:rounded-3xl shadow-2xl">
                            <motion.form
                                ref={form}
                                onSubmit={sendEmail}
                                className="space-y-5"
                            ...
                            >
                                ...
                                {status && (
                                    <motion.div
                                        ...
                                        className={`p-4 rounded-xl text-center text-sm font-bold ${status.type === 'success' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-50 text-red-400 border border-red-500/20'}`}
                                    >
                                        {status.message}
                                    </motion.div>
                                )}
